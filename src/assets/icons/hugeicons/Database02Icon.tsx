...
export default function Database02Icon({ variant, ...rest }: HugeIconProps) {
...
<Path d="M20 12C20 13.6569 16.4183 15 12 15C7.58172 15 4 13.6569 4 12" stroke={color} strokeWidth={strokeWidth}/>
<Path d="M20 5V19C20 20.6569 16.4183 22 12 22C7.58172 22 4 20.6569 4 19V5" stroke={color} strokeWidth={strokeWidth}/>
<Path d="M8 8V10" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round"/>
<Path d="M8 15V17" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round"/>
</Svg>
)
}
