import { PSemiBold, PoppinsSemiBold, PoppinsMedium, PMedium } from '@utils/fonts'
  ...
  return (
    <View className='w-full flex-row items-center p-2' style={{ gap: 20 }}>
      ...
      <View className='w-full flex-[0]' style={{ flexGrow: 1 }}>
        <PSemiBold style={{ fontSize: 14.5 }} className='text-zinc-700 dark:text-zinc-300'>
          {title}
        </PSemiBold>
        <PMedium style={{ fontSize: 13 }} className='text-zinc-400 dark:text-zinc-500'>
          {description}
        </PMedium>
      </View>
    </View>
