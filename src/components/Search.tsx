...
import { TextInput, type TextInputProps, TouchableOpacity, View, useColorScheme } from 'react-native'
...
export default function Search({ onChangeText, value, ...all }: TextInputProps) {
  ...
  return (
    ...
    >
      <Search01Icon
        size={17}
        color={scheme === 'dark' ? Colors.zinc[500] : Colors.zinc[400]}
      ...
      <TextInput
        ...
        style={[SEMIBOLD, { fontSize: MAIN_TEXT_SIZE, marginBottom: 3, height: 40 }]}
