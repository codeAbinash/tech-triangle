    ...
    <SettWrapper title='Weather Settings'>
      <Gap12>
        ...
        <SettGroup title='General Settings'>
          <SettOption
            ...
            Icon={<RoundIcon Icon={DashboardSquare02Icon} gradient='blue' />}
            Right={<Toggle isActive={weatherWidgetIsActive} accent={Colors.blue[500]} />}
          />
          <SettOption
            title='Current City'
            // Icon={<City03Icon {...ic} />}
            Icon={<RoundIcon Icon={City03Icon} gradient='slate' />}
            arrow
          ...
          {dev && (
            <>
              <SettOption
                ...
                Icon={<RoundIcon Icon={PencilEdit02Icon} gradient='yellow' />}
                arrow
      ...
      <Gap12>
        <SettGroup title='Accuweather API key'>
          <Input
            // Icon={<Key01Icon {...ic} />}
            Icon={<RoundIcon Icon={Key01Icon} gradient='blue' />}
        ...
        <Gap12>
          <SettGroup title='Weather Cache Time'>
            <Input
              ...
              Icon={<RoundIcon Icon={DatabaseRestoreIcon} gradient='slate' />}
              Right={<Txt>ms</Txt>}
      ...
      <SettGroup title='Data Management'>
        ...
        <SettOption
          ...
          Icon={<RoundIcon Icon={Database02Icon} gradient='red' />}
    ...
    <>
      <SettGroup title={'Units'}>
        ...
        <SettOption
          ...
          Icon={<RoundIcon Icon={FastWindIcon} gradient='green' />}
        ...
        <SettOption
          ...
          Icon={<RoundIcon Icon={SortingDownIcon} gradient='slate' />}
        ...
        <SettOption
          ...
          Icon={<RoundIcon Icon={Clock01Icon} gradient='yellow' />}
