...
import { BackHeader, Gap12, Gap20, SettingText } from '@components/Settings'
  ...
  return (
    <View className='flex-1 bg-zinc-100 dark:bg-black'>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 30 }} showsHorizontalScrollIndicator={false} showsVerticalScrollIndicator={false}>
        <Gap20>
          <Gap12>
            <SettingText className='pt-3'>Here are some settings related to Computer Science functionality in the app.</SettingText>
          </Gap12>
        </Gap20>
        <PaddingBottom />
      </ScrollView>
